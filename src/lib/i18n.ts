const translations = {
  ...
  "error.notFound.description": "La page que vous recherchez n'existe pas.",
  "payment.progressBar.ariaLabel": "{{paid}} échéances payées sur {{total}}",
  "payments.details.installment.paid": "Payé",
  "payments.details.installment.late": "En retard",
  "payments.details.installment.pending": "À venir",
  ...
  "payments.details.back": "Retour",
  "payments.details.installmentCount": "{{count}}x sans frais",
  "payments.details.installmentCountWithFees": "{{count}}x",
  "payments.details.remaining": "Reste à payer",
  "payments.details.totalPaid": "Tout est payé",
  "payments.details.paymentMethod": "Moyen de paiement",
  "payments.details.cardLabel": "{{brand}} •••• {{last4}}",
  "payments.details.cardExpiry": "Expire {{month}}/{{year}}",
  "payments.details.totalFees": "Frais",
  "payments.details.orderReference": "Référence",
  "payments.details.error.message": "Impossible de charger ce paiement.",
  "payments.details.error.retry": "Réessayer",
